...
// Админ ва Канал текстли тугмалари
...
// Тариф танланганда админга хабар бориши
bot.action(/tariff_/, (ctx) => {
  ctx.answerCbQuery();
  ctx.reply('Раҳмат! Тез орада админ сиз билан боғланади ва эълонингиз сайтга жойланади.');
  bot.telegram.sendMessage(ADMIN_ID, `Янги мижоз! \nUsername: @${ctx.from.username} \nТанлаган тарифи: ${ctx.match.input}`);
});

// Ботни ишга тушириш (Энг пастда бўлиши керак)
bot.launch();
